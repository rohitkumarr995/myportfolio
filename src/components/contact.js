            ...
            <div className="map-section">
                ...
                <div className="google-map-iframe">
                    <iframe
                        ...
                        marginheight="0"
                        marginwidth="0"
                        src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Adanbagh,%20Dayalbagh,%20Agra+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                    >
                    ...
                    <div className="user-markers">
                        <div className="user-marker-component">
                            ...
                            <div className="marker-details">
                                ...
                                <p id="marker-desc">Dayalbagh, Agra, Uttar Pradesh, India 282005</p>
                            </div>
                        </div>
                        <div className="user-marker-component">
                            <div className="marker">
